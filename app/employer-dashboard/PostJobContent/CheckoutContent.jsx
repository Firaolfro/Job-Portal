// app/employer-dashboard/CheckoutContent.jsx
"use client";
...
export default function CheckoutContent({
  ...
  //   e.preventDefault();
  //   // Here you would handle the actual payment processing logic
  //   // e.g., send data to a payment gateway
  //   console.log("Processing payment for:", defaultSelectedPlan.name);
  //   console.log("Payment Method:", paymentMethod);
  //   if (paymentMethod === "card" && selectedPaymentOption === "new") {
  //     console.log("Card Details:", { cardNumber, nameOnCard, expiryDate, cvc });
  //   }

  //   // Simulate successful payment:
  //   // alert(`Payment for ${defaultSelectedPlan.name} would be processed here!`); // Removed alert

  //   // On successful payment, close the modal and navigate.
  //   if (onClose) {
  //     onClose();
  //   }

  //   // router.push("/employer-dashboard/PostJobContent/post-a-job");
  //   // router.push("/employer-dashboard/PostJobContent");
  //   // router.push("/employer-dashboard/PostJobContent/post-a-job");
  //   // router.push("/employer-dashboard/PostJobContent/post-a-job"); // This is the correct route to your page

  //   // router.push("/employer-dashboard/PostJobForm");
  //   // router.push("/employer-dashboard/post-a-job");
