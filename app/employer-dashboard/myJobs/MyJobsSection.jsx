// employer-dashboard/myJobs/MyJobsSection/MyJobsSection.jsx
"use client";
...
export default function MyJobsSection() {
  ...
  const handleViewApplications = (jobId, jobTitle) => {
    ...
    router.push(
      `/employer-dashboard/myJobs/${jobId}/applications?jobTitle=${encodeURIComponent(
        jobTitle
      )}`
    );
...
// You might need to define this in your tailwind.config.js
// theme: {
//   extend: {
//     gridTemplateColumns: {
//       'my-jobs-table': '2fr 1fr 1.5fr 2fr', // Example: Adjust as needed for your layout
//     },
//   },
// },
