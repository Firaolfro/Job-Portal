    ...
    <div className="p-6">
          ...
          <div className="flex justify-between pb-4">
            <div>
              ...
              <input
                ...
                className="w-63 border rounded-md p-2 mb-2"
      ...
      <div className="p-6">
        ...
        <div onClick={() => setShowModal(true)} className="cursor-pointer">
          <label className="w-64 bg-gray-50 cursor-pointer border-3 border-dashed rounded-md p-4 flex flex-col items-center justify-center text-gray-400 hover:bg-gray-200 transition">
